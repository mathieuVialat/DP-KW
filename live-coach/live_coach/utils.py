...
class BootstrapHelper(object):
  ...
  def __init__(self,
    ...
    self._pose_class_names = sorted([n for n in os.listdir(self._images_in_folder) if not n.startswith('.') and not n.endswith('.txt')])
  ...
  def bootstrap(self, per_pose_class_limit=None):
    ...
    for pose_class_name in self._pose_class_names:
      ...
      with open(csv_out_path, 'w') as csv_out_file:
        ...
        # Get list of images.
        image_names = sorted([n for n in os.listdir(images_in_folder) if not n.startswith('.') and not n.endswith('.txt')])
...
# Output folders for bootstrapped images and CSVs.
#bootstrap_images_out_folder = 'Data/fitness_poses_images_out'
...
out_video_path = 'pushups-sample-out_test.mp4'


def entrainement(input_number):
    # Data pour l'entrainement : 
    bootstrap_images_in_folder = './../../Data/fitness_poses_images_in/train/'
    # Output folders for bootstrapped images and CSVs.
    bootstrap_images_out_folder = './../../Data/fitness_poses_images_out'
    bootstrap_csvs_out_folder = './../../Data/fitness_poses_csvs_out'
    ...
    bootstrap_helper.print_images_in_statistics()
    # Bootstrap all images.
    bootstrap_helper.bootstrap(per_pose_class_limit=input_number)
    # Check how many images were bootstrapped.
    bootstrap_helper.print_images_out_statistics()
...
def classification(input_path, output):
    ...
    # Open output video.
    out_video = cv2.VideoWriter(output, cv2.VideoWriter_fourcc(*'mp4v'), video_fps, (video_width, video_height))
